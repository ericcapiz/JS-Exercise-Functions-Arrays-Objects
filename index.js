...
*/
function temperatureInF(fahrenheit, unit) {
  /* code here */
  if (unit == 'C') {
     return temperatureCtoF(fahrenheit) + 'F';
  } else if (unit == 'F'){
...
console.log(makePersonObject(3, 'eric', 'eric@gmail.com'));
...
function getName(id, name, email) {
  ...
  const person = {
   ...
   console.log(getName(3, 'eric', 'eric@gmail.com'));
